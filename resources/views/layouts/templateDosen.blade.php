                ...
                <div class="hidden lg:flex flex-col lg:flex-row justify-center items-center w-full lg:w-auto">
                    <div class="flex flex-wrap justify-center gap-2 lg:flex-nowrap lg:space-x-4">
                        <a href="{{ route('dosen.home') }}"
                           class="text-[#4D4D4D] hover:bg-[#FFDA7A] px-3 py-2 lg:px-4 rounded-md text-sm lg:text-base font-medium transition duration-200 font-noto whitespace-nowrap {{ request()->routeIs('dosen.home') ? 'bg-[#FFDA7A]' : '' }} relative z-10 cursor-pointer hover:translate-y-[-2px] hover:shadow-md active:translate-y-0">
                            Home
                        </a>
                        <a href="{{ route('dosen.janjiTemu') }}"
                           class="text-[#4D4D4D] hover:bg-[#FFDA7A] px-3 py-2 lg:px-4 rounded-md text-sm lg:text-base font-medium transition duration-200 font-noto whitespace-nowrap {{ request()->routeIs('dosen.janjiTemu') ? 'bg-[#FFDA7A]' : '' }} relative z-10 cursor-pointer hover:translate-y-[-2px] hover:shadow-md active:translate-y-0">
                            Janji Temu
                        </a>
                        <a href="{{ route('dosen.tandaTangan') }}"
                           class="text-[#4D4D4D] hover:bg-[#FFDA7A] px-3 py-2 lg:px-4 rounded-md text-sm lg:text-base font-medium transition duration-200 font-noto whitespace-nowrap {{ request()->routeIs('dosen.tandaTangan') ? 'bg-[#FFDA7A]' : '' }} relative z-10 cursor-pointer hover:translate-y-[-2px] hover:shadow-md active:translate-y-0">
                            Tanda Tangan
                        </a>
                        <a href="{{ route('dosen.jadwalMendatang') }}"
                           class="text-[#4D4D4D] hover:bg-[#FFDA7A] px-3 py-2 lg:px-4 rounded-md text-sm lg:text-base font-medium transition duration-200 font-noto whitespace-nowrap {{ request()->routeIs('dosen.jadwalMendatang') ? 'bg-[#FFDA7A]' : '' }} relative z-10 cursor-pointer hover:translate-y-[-2px] hover:shadow-md active:translate-y-0">
                            Jadwal Mendatang
                        </a>
                        <a href="{{ route('dosen.history') }}"
                           class="text-[#4D4D4D] hover:bg-[#FFDA7A] px-3 py-2 lg:px-4 rounded-md text-sm lg:text-base font-medium transition duration-200 font-noto whitespace-nowrap {{ request()->routeIs('dosen.history') ? 'bg-[#FFDA7A]' : '' }} relative z-10 cursor-pointer hover:translate-y-[-2px] hover:shadow-md active:translate-y-0">
                            History
                        </a>
                    </div>
                </div>
