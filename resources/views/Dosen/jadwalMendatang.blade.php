...
@section('content')
    ...
    <main class="justify-start max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row gap-6">
            <!-- Calendar Mobile (Tampil di atas di mobile) -->
            <div class="block lg:hidden w-full">
                <div class="flex justify-start relative mb-6">
                    <button id="calendar-button-mobile"
                        class="text-[#4D4D4D] gap-2 text-sm font-medium bg-[white] border border-[#C1C1C1] hover:bg-[#FFDA7A] rounded-md px-4 py-4 flex items-center justify-between w-full">
                        <span class="text-sm">Kamis, 18 September 2025</span>
                        <img src="{{ asset('images/panah.png') }}" alt="dropdown Icon" class="w-[18px] h-[16px]">
                    </button>

                    <!-- Calendar Dropdown Menu Mobile -->
                    <div id="calendar-dropdown-mobile"
                        class="hidden absolute left-0 top-full mt-2 w-full bg-white rounded-lg shadow-lg border border-gray-200 z-50 p-4">
                        <!-- Calendar Header -->
                        <div class="flex justify-between items-center mb-4">
                            <button class="prev-month text-gray-600 hover:text-gray-800 p-2 rounded-lg hover:bg-gray-100">
                                <i class="fas fa-chevron-left text-sm"></i>
                            </button>
                            <span class="font-bold text-[#4D4D4D] text-sm">September 2025</span>
                            <button class="next-month text-gray-600 hover:text-gray-800 p-2 rounded-lg hover:bg-gray-100">
                        ...
                        <div class="mt-4 pt-3 border-t border-gray-200">
                            <button class="today-btn w-full bg-[#F1F1F1] text-[#4D4D4D] py-2 rounded-lg text-sm font-medium hover:bg-gray-200 transition duration-200">
                                Hari Ini
                            </button>
                        </div>
                    </div>
            ...
            <div class="flex-1 space-y-6">
                ...
                <div class="rounded-lg p-4 sm:p-6 bg-[#F1F1F1] relative z-0">
                    {{--  Card 1 --}}
                    <div class="bg-white border-l-4 border-white pl-4 py-3 gap-4 mb-4 rounded-2xl relative z-10 cursor-pointer hover:translate-y-[-2px] hover:shadow-md active:translate-y-0">
                        <div class="bg-white border-l-8 border-[#FFD66B] pl-4 py-3 gap-4 mb-4">
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 mb-3">
                                ...
                                <span class="font-bold text-sm sm:text-[16px] text-[#4D4D4D]">Bimbingan Tugas Akhir</span>
                            </div>
            ...
            <!-- Kanan (Desktop) -->
            <div class="hidden lg:block w-full lg:w-80 space-y-6">
                <div class="flex justify-start relative">
                    <button id="calendar-button-desktop"
                        ...
                        <span>Kamis, 18 September 2025</span>
                        <img src="{{ asset('images/panah.png') }}" alt="dropdown Icon" class="w-[18px] h-[16px]">
                    </button>

                    <!-- Calendar Dropdown Menu Desktop -->
                    <div id="calendar-dropdown-desktop"
                        class="hidden absolute right-0 top-full mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50 p-4">
                        <!-- Calendar Header -->
                        <div class="flex justify-between items-center mb-4">
                            <button class="prev-month text-gray-600 hover:text-gray-800 p-2 rounded-lg hover:bg-gray-100">
                                <i class="fas fa-chevron-left text-sm"></i>
