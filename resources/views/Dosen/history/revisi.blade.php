            ...
            <div class="mb-6">
                <div class="flex items-start mb-3">
                    ...
                    <div class="flex flex-col flex-1">
                        <h2 class="text-lg sm:text-xl md:text-2xl font-medium text-[#0A0A0A] mb-2 ml-0 sm:ml-2">Proposal Tugas Akhir</h2>
                        <div class="flex flex-wrap items-center gap-2 ml-0 sm:ml-2">
                            ...
                            <span class="bg-[#FFEDD4] text-[#9F2D00] px-2 sm:px-3 py-1 rounded-full text-xs font-medium">
                                Revisi
                            </span>
                            <span class="bg-[#FFEDD4] text-[#9F2D00] px-2 sm:px-3 py-1 rounded-full text-xs font-medium">
                                Revisi Ke-2
                    ...
                    <img src="{{ asset('images/revisi.png') }}" alt="revisi" class="w-5 h-5 sm:w-6 sm:h-6 ml-2 flex-shrink-0">
                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs sm:text-sm text-gray-500">Dokumen memerlukan perbaikan lebih lanjut</p>
                ...
                <div class="bg-[#FFF7ED] p-3 sm:p-4 rounded-lg border border-[#BEDBFF] mt-2 mb-4">
                    <div class="flex items-start gap-2 mb-3">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-[#7E2A0C]">Catatan Revisi</span>
                    </div>
                    <p class="text-xs sm:text-sm text-[#9F2D00] ml-0 sm:ml-7 leading-relaxed">
                        Judul perlu diperjelas. Metodologi penelitian belum detail. Tambahkan studi literatur yang lebih komprehensif (minimal 15 jurnal internasional 5 tahun terakhir).
                    </p>
                    <p class="text-xs italic text-[#CA3500] ml-0 sm:ml-7 leading-relaxed mt-2">
                        Dokumen berkomentar telah dilampirkan dengan detail perbaikan pada setiap bagian.
                    </p>
                </div>
            </div>
