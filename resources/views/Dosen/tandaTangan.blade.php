                ...
                <div class="flex justify-between items-center mb-4 relative">
                    ...
                    <div class="relative">
                        <button id="sort-menu-button"
                            class="text-[#4D4D4D] gap-2 text-sm font-medium bg-[white] border border-[#C1C1C1] hover:bg-[#FFDA7A] rounded-md py-2 px-6 flex items-center">
                            Terbaru
                        ...
                        <!-- Dropdown Menu -->
                        <div id="sort-menu"
                            class="hidden absolute right-0 top-full mt-1 w-48 bg-white rounded-md shadow-lg py-2 z-10 border border-gray-200">
                            <div class="space-y-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 bg-white px-6 py-6 w-full max-w-none">
                            <div class="flex justify-between items-start mb-6">
                                <div class="flex items-start gap-4 w-full">
                                    <div class="flex items-start gap-2 flex-1">
                                        <img src="{{ asset('images/dokumen.png') }}" alt="ikonDokumen"
                                            class="w-6 h-6 mt-1">
                                        <div class="max-w-[180px] flex-1">
                                            <h3 class="text-[15px] leading-tight line-clamp-2">Persetujuan KRS Semester
                                                Ganjil
                                            </h3>
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="max-w-[180px] mb-6 w-full">
                                    <p class="text-[13px] leading-tight line-clamp-2 w-full">Permohonan persetujuan KRS
                                        untuk
                                        semester ganjil 2024/2025. Total 21 SKS.</p>
                                </div>
                            </div>
