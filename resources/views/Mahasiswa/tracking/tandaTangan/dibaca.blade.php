        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                <h2 class="text-lg sm:text-xl md:text-[18px] font-medium text-[#0A0A0A] mb-2 sm:mb-0">Persetujuan KRS
                    Semester Ganjil</h2>
                <span class="bg-[#DBEAFE] text-[#4D4D4D] px-3 py-1 rounded-full text-xs font-medium w-fit">
                    Dibaca
                </span>
            </div>
            <!-- Informasi mahasiswa -->
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/dokumenUserTTD.png') }}" alt="DokumenIkon"
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/selesaiUserTTD.png') }}" alt="userIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                    <div class="h-6 sm:h-8 border-l-2 border-dashed border-gray-300 mt-2"></div>
                                </div>
                                <div class="flex-1">
                                    <p class="font-medium text-gray-700 text-sm sm:text-base">Diterima Dosen</p>
                                    <p class="text-xs sm:text-sm text-gray-500">Dosen telah membuka dan membaca dokumen Anda. Sedang dalam proses peninjauan.
                                    </p>
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/jamDibaca.png') }}" alt="jamIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                    <div class="h-6 sm:h-8 border-l-2 border-dashed border-gray-300 mt-2"></div>
                                </div>
                                <div class="flex-1">
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/unduhDibaca.png') }}" alt="unduhIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                    <div class="h-6 sm:h-8 border-dashed border-gray-300 mt-2"></div>
                                </div>
                                <div class="flex-1">
                                    <p class="font-medium text-gray-700 text-sm sm:text-base">Menunggu</p>
                                </div>
                            </div>
                        </div>
                    </div>
