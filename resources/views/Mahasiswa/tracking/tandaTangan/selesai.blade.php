                ...
                <div class="mb-6">
                    <div class="bg-white p-3 sm:p-4 rounded-lg border border-white">
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/dokumenUserTTD.png') }}" alt="DokumenIkon"
                                        class="w-[50px] h-[50px] sm:w-8 sm:h-8 inline-block">
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/selesaiJamTTD.png') }}" alt="JamIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                    <div class="h-6 sm:h-8 border-l-2 border-dashed border-gray-300 mt-2"></div>
                                </div>
                                <div class="flex-1">
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/selesaiUnduhTTD.png') }}" alt="UnduhIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
