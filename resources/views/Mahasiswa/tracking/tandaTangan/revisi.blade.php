    ...
    <main class="justify-start max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                <h2 class="text-lg sm:text-xl md:text-[18px] font-medium text-[#0A0A0A] mb-2 sm:mb-0">Persetujuan KRS
                    Semester Ganjil</h2>
                <span class="bg-[#FFEDD4] text-[#4D4D4D] px-3 py-1 rounded-full text-xs font-medium w-fit">
                    Perlu Revisi
                </span>
            </div>
            <!-- Informasi mahasiswa -->
            ...
            <button
                class="mt-8 px-4 sm:px-6 py-2 bg-[#FF8733] text-white rounded-lg hover:bg-[#c66926] transition duration-200 flex items-center justify-center gap-2">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="#" method="POST">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/dokumenRevisi.png') }}" alt="DokumenIkon"
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/userRevisi.png') }}" alt="DokumenIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                    <div class="h-6 sm:h-8 border-l-2 border-dashed border-gray-300 mt-2"></div>
                                </div>
                                <div class="flex-1">
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/jamRevisi.png') }}" alt="DokumenIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                    <div class="h-6 sm:h-8 border-l-2 border-dashed border-gray-300 mt-2"></div>
                                </div>
                                <div class="flex-1">
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/unduhRevisi.png') }}" alt="DokumenIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs sm:text-sm text-gray-500">Dokumen memerlukan perbaikan sebelum dapat disetujui.
                                    </p>
                ...
                <div class="bg-[#FFF0E6] border border-[#FF6900] rounded-lg shadow-md mb-6 p-4">
                    <div class="flex items-start">
                        <div class="flex flex-col items-start mr-3 sm:mr-4">
                            <h3 class="text-[18px] text-[#4D4D4D] font-semibold ">Alasan Revisi</h3>
                            <p class="text-[#4D4D4D] text-sm sm:text-base">
                                Mohon melengkapi foto copy KTP yang masih berlaku dan surat keterangan dari orang tua. Format penulisan nama pada dokumen juga perlu disesuaikan dengan data akademik.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <div
                        class="border-2 border-dashed border-[#FF6900] rounded-lg p-8 text-center hover:border-[#c66926] transition-colors duration-200">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="mt-2 text-sm text-[#4D4D4D]">Drop file di sini atau
                                <span class="text-[#FF6900] font-medium">pilih file</span>
                            </p>
                ...
                <button
                    class="ml-auto px-4 sm:px-6 py-2 bg-[#FF8733] text-white rounded-lg hover:bg-[#c66926] transition duration-200 flex items-center justify-center gap-2">
                    <img src="{{ asset('images/downloadPutih.png') }}" alt="UnduhDokumenIkon" class="w-4 h-4 inline-block">
