    ...
    <main class="justify-start max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                <h2 class="text-lg sm:text-xl md:text-[18px] font-medium text-[#0A0A0A] mb-2 sm:mb-0">
                    Bimbingan Skripsi
                </h2>
                <span class="bg-[#DBEAFE] text-[#193CB8] px-3 py-1 rounded-full text-xs font-medium w-fit">
                    Dijadwal Ulang
                </span>
            </div>
            <!-- Informasi mahasiswa -->
            <div class="space-y-3">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col">
                        <p class="text-[#4D4D4D] font-[16px]">Kamis, 2 Oktober 2025</p>
                        <p class="text-[#4D4D4D] text-sm">10:00 - 10:30</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/tanggalJadwal.png') }}" alt="jadwalIkon"
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/userJadwal.png') }}" alt="UserIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                    <div class="h-6 sm:h-8 border-l-2 border-dashed border-gray-300 mt-2"></div>
                                </div>
                                <div class="flex-1">
                                    <p class="font-medium text-gray-700 text-sm sm:text-base">Diterima Dosen</p>
                                    <p class="text-xs sm:text-sm text-gray-500">Dosen telah melihat permintaan janji temu Anda dan sedang mempertimbangkan jadwal.</p>
                                    <p class="text-xs sm:text-sm text-gray-500">30 Okt 2024, 09:30</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                <div class="flex flex-col items-center mr-3 sm:mr-4">
                                    <img src="{{ asset('images/tracking/silangJadwal.png') }}" alt="silangIkon"
                                        class="w-7 h-7 sm:w-8 sm:h-8 inline-block">
                                    <div class="h-6 sm:h-8 mt-2"></div>
                                </div>
                                <div class="flex-1">
                                    <p class="font-medium text-gray-700 text-sm sm:text-base">Perlu Penjadwalan Ulang</p>
                                    <p class="text-xs sm:text-sm text-gray-500">Dosen tidak dapat hadir pada waktu yang diajukan. Mohon ajukan jadwal baru.</p>
                                    <p class="text-xs sm:text-sm text-gray-500">30 Okt 2024, 09:30</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="bg-[#EFF6FF] border border-[#BEDBFF] rounded-lg shadow-md p-4">
                <div class="flex items-start">
                    <div class="flex flex-col items-center mr-3 sm:mr-4">
                        <img src="{{ asset('images/x.png') }}" alt="xIkon"
                            class="w-6 h-6 sm:w-8 sm:h-8 inline-block">
                    </div>
                    <div class="flex-1">
                        <p class="font-medium text-[#4D4D4D] text-[18px] sm:text-base">Perlu jadwal ulang - silakan ajukan hari lain</p>
                    </div>
                </div>
            </div>
        </div>
